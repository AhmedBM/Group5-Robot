...
#include "seg4145_group_5_lab_2.h"
  ...
  switch (msg->message_data[MSG_F_TYPE]) {
    ...
    case MSG_I_MOD_REPLY:
       ...
       */
       ...
       /* Left Wheel Value */
       if (msg->message_data[MSG_F_DATA] == LEFT_WHEEL)
       {
        counter_left = msg->message_data[MSG_F_DATA+1];
        reply_left = 1;
       }
       else if (msg->message_data[MSG_F_DATA] == RIGHT_WHEEL)
       {
        counter_right = msg->message_data[MSG_F_DATA+1];
        reply_right = 1;
       }
